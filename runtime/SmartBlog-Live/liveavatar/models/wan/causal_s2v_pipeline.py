...
class WanS2V:
    ...
    def generate(
        ...
        if req_repeat > nr_eff:
            # Keep requested tail coverage even when encoder returns smaller nr.
            # Pad audio embeddings with silence frames so generation does not end
            # visibly before audio playback tail.

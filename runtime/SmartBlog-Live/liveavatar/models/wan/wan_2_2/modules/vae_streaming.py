...
from liveavatar.models.wan.inference_utils import conditional_compile, disable
import torch
...
class WanVAE:
    ...
    # NOTE: stream_decode is stateful (it updates internal causal-conv caches).
    # torch.compile on this path has been observed to produce progressive visual
    # corruption ("scaly/mosaic" artifacts) during long rollouts. Keep it eager.
    @disable
